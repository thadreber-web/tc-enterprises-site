...
export default function ChatWidget() {
  ...
  <div className={`fixed bottom-24 right-5 w-full max-w-sm rounded-lg border border-gray-200 dark:border-gray-700 bg-background dark:bg-background-dark shadow-lg flex-col ${isOpen ? 'flex' : 'hidden'}`}>
      ...
      <button
        ...
        className="fixed bottom-5 right-5 flex h-12 w-12 items-center justify-center rounded-full bg-accent text-white shadow-lg hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-accent"
