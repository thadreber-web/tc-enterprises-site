...
const projects = [
  ...
  },
  {
    ...
    outcome: 'In active development. Validates complex data pipeline architecture across multiple data sources.',
  ...
  },
  {
    ...
    outcome: 'In active development. Demonstrates expertise in creative tooling and visual interface design.',
