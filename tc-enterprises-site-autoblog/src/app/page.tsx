...
export default function Home() {
  return (
    <div className="space-y-16">
      ...
      {/* HOW IT WORKS — 3-step process reassurance */}
      <section className="py-12">
        <div className="text-center mb-10">
          <h2 className="text-3xl md:text-4xl font-bold text-foreground dark:text-foreground-dark mb-3">
            How It Works
          </h2>
          <p className="text-lg text-muted dark:text-muted-foreground max-w-2xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
          <div className="text-center space-y-3">
            <div className="w-14 h-14 rounded-full bg-primary text-white text-xl font-bold flex items-center justify-center mx-auto">1</div>
            <h3 className="font-semibold text-foreground dark:text-foreground-dark">Send Your Logo</h3>
            <p className="text-sm text-muted dark:text-muted-foreground">
              Email any format — JPG, PNG, PDF, AI. Even low-resolution or blurry artwork works.
            </p>
          </div>

          <div className="text-center space-y-3">
            <div className="w-14 h-14 rounded-full bg-primary text-white text-xl font-bold flex items-center justify-center mx-auto">2</div>
            <h3 className="font-semibold text-foreground dark:text-foreground-dark">I Convert It</h3>
            <p className="text-sm text-muted dark:text-muted-foreground">
              I hand-trace your artwork into production-ready EPS or PLT files, optimized for your engraving equipment.
            </p>
          </div>

          <div className="text-center space-y-3">
            <div className="w-14 h-14 rounded-full bg-primary text-white text-xl font-bold flex items-center justify-center mx-auto">3</div>
            <h3 className="font-semibold text-foreground dark:text-foreground-dark">Files in Your Inbox</h3>
            <p className="text-sm text-muted dark:text-muted-foreground">
              Delivery within 24 hours. Drop straight into your engraving software — no cleanup required.
            </p>
          </div>
        </div>
      </section>
