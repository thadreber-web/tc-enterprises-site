  ...
  return (
    <div className="space-y-12">
      ...
      <div className="bg-background dark:bg-background-dark rounded-lg p-8">
        <h2 className="text-3xl font-bold text-foreground dark:text-foreground-dark mb-6">Key Problems Solved</h2>
        <div className="grid md:grid-cols-1 gap-8">
          
          <div>
            <h3 className="text-xl font-bold text-primary">From Chaos to Control</h3>
            <p className="mt-2 text-muted">Replaced a chaotic system of shared folders with an organized, searchable, and secure library, eliminating the risk of exposing raw vector files.</p>
          </div>
      ...
      <div className="text-center py-12">
        <h3 className="text-2xl font-bold text-foreground dark:text-foreground-dark">Features & Scale</h3>
        <div className="mt-4 grid md:grid-cols-3 gap-4 max-w-4xl mx-auto">
            <div className="bg-background dark:bg-background-dark rounded-lg p-4">
                ...
                <p className="text-muted dark:text-gray-300">EPS Files Managed</p>
            </div>
            <div className="bg-background dark:bg-background-dark rounded-lg p-4">
                <p className="text-3xl font-bold text-primary">FTS</p>
                <p className="text-muted dark:text-gray-300">Fast, Full-Text Search</p>
            </div>
            <div className="bg-background dark:bg-background-dark rounded-lg p-4">
