    ...
    <div className="space-y-12">
      ...
      <div className="text-center py-12">
        ...
        <div className="mt-4 flex flex-wrap justify-center gap-4 text-muted">
                    <span className="bg-background dark:bg-background-dark rounded-full px-4 py-2">React (Vite)</span>
                    <span className="bg-background dark:bg-background-dark rounded-full px-4 py-2">Express</span>
          <span className="bg-background dark:bg-background-dark rounded-full px-4 py-2">TypeScript</span>
          <span className="bg-background dark:bg-background-dark rounded-full px-4 py-2">Prisma</span>
