    ...
    <div className="space-y-12">
      ...
      <div className="text-center py-12">
        ...
        <div className="mt-4 flex flex-wrap justify-center gap-4 text-text-muted">
          <span className="bg-bg-surface dark:bg-bg-surface-dark rounded-full px-4 py-2">Django</span>
          ...
          <span className="bg-bg-surface dark:bg-bg-surface-dark rounded-full px-4 py-2">Google Gemini</span>
